...
$pdf->SetFont('Arial', '', 12);
$pdf->MultiCell(0, 8, "Title Tag: " . mb_convert_encoding($title, 'ISO-8859-1', 'UTF-8'));
$pdf->MultiCell(0, 8, "Primary H1: " . mb_convert_encoding($h1, 'ISO-8859-1', 'UTF-8'));
...
$pdf->MultiCell(0, 6, mb_convert_encoding($aiAnalysis, 'ISO-8859-1', 'UTF-8'));
